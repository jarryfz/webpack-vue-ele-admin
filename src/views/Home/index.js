...
export default {
  data () {
    ...
    // 全彩屏，双基色屏，简易屏，条形屏
    const offLine = [
      [20, 40, 60, 60, 10, 20, 40, 20],
      [10, 30, 50, 20, 50, 30, 30, 40],
      [50, 20, 40, 10, 20, 40, 20, 30],
      [20, 10, 30, 40, 10, 10, 10, 40]
    ]
    const onLine = [
      [10, 20, 20, 40, 20, 10, 60, 60],
      [20, 10, 40, 30, 30, 50, 20, 50],
      [30, 30, 30, 20, 40, 20, 10, 40],
      [40, 40, 40, 10, 10, 10, 40, 30]
    ]
    const offLineSum = [100, 100, 180, 130, 90, 100, 100, 130]
    const onLineSum = [100, 100, 130, 100, 100, 90, 130, 180]
    return {
      options: {
        tooltip: {
          trigger: 'axis',
